...
NUM_SECOND_HLY = 64
model = Sequential()
# model.add(Dense(units=32, input_dim=5, activation='linear'))
model.add(Dense(NUM_FIRST_HLY, kernel_initializer='lecun_uniform', input_shape=(NUM_INPUT,)))
model.add(Activation('relu'))
model.add(Dense(NUM_SECOND_HLY, kernel_initializer='lecun_uniform'))
model.add(Activation('relu'))
model.add(Dense(NUM_OUTPUT, kernel_initializer='lecun_uniform'))
